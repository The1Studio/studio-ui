...
export type { DateRange, DateRangePickerProps, FormDateRangePickerProps };
...
export function DateRangePicker(props: DateRangePickerProps) {
  ...
  const tempStartDayjs: DateType = tempStartDate ? dayjs(tempStartDate) : undefined;
  const tempEndDayjs: DateType = tempEndDate ? dayjs(tempEndDate) : undefined;

  // Handle DateTimePicker change (convert dayjs to Date)
  const onPickerChange = (params: { startDate: DateType; endDate: DateType }) => {
    const start = params.startDate ? dayjs(params.startDate).toDate() : null;
    const end = params.endDate ? dayjs(params.endDate).toDate() : null;
    handleDateChange(start, end);
  };

  const displayValue = getDisplayValue(formatDate);
  ...
  return (
    <View style={[styles.container, containerStyle]}>
      ...
      >
        ...
        {clearable && value?.startDate && !isDisabled && (
          <TouchableOpacity
            onPress={handleClear}
      ...
      >
        <View style={styles.backdrop}>
          ...
          <View style={styles.modalContent}>
            ...
            <DateTimePicker
              mode="range"
              startDate={tempStartDayjs}
              endDate={tempEndDayjs}
